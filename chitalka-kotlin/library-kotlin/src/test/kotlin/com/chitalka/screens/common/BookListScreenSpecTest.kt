...
class BookListScreenSpecTest {
    ...
    @Test
    fun emptyListMessage_picksSearchKeyOnActiveSearch() {
        val withSearch = BookListScreenSpec.Favorites.emptyListMessage(ru, hasActiveSearch = true)
        val withoutSearch = BookListScreenSpec.Favorites.emptyListMessage(ru, hasActiveSearch = false)
